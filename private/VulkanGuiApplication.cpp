...
void VulkanGuiApplication::ImGui_BeginDockSpace()
{
	static bool open_dock_space = true;
	static bool* p_open = &open_dock_space;
...
void VulkanGuiApplication::ImGui_DrawWidget()
{
	for (auto& ImGuiDrawFunction : _ImGuiDrawFunctions)
	{
		ImGuiDrawFunction.second();
	}
}

void VulkanGuiApplication::ImGui_EndDockSpace()
{
