...
EASYGUI_API extern std::unordered_map<std::thread::id, ThreadTaskQueue*> G_ThreadIdToTaskQueueMap;
EASYGUI_API ThreadTaskQueue& CurrentThreadTaskQueueRef();

class EASYGUI_API ThreadTaskQueue
{
public:
